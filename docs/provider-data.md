...
Medical claims include several fields containing provider data. The type of data varies, depending on the type of claim.


## What provider information is included in claims data?
